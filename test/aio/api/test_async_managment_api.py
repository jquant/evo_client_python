...
@pytest.mark.asyncio
async def test_process_excel_response_success(management_api: AsyncManagementApi):
...
@pytest.mark.asyncio
async def test_process_excel_response_non_200_status(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_excel_response_non_bytes_data(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_excel_response_invalid_excel(management_api: AsyncManagementApi):
...
@pytest.mark.asyncio
async def test_process_excel_response_with_invalid_row_data(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_prospects_excel_response_success(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_prospects_excel_response_error(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_non_renewed_excel_response_success(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_process_non_renewed_excel_response_error(
    management_api: AsyncManagementApi,
):
...
@pytest.mark.asyncio
async def test_get_active_clients_unexpected_error(
    management_api: AsyncManagementApi, mock_api_client: Mock
):
...
@pytest.mark.asyncio
async def test_get_prospects_unexpected_error(
    management_api: AsyncManagementApi, mock_api_client: Mock
):
    ...
    with pytest.raises(ApiException, match="Unexpected error"):
        await management_api.get_prospects()


@pytest.mark.asyncio
async def test_get_non_renewed_clients_unexpected_error(
    management_api: AsyncManagementApi, mock_api_client: Mock
):
    ...
    with pytest.raises(ApiException, match="Unexpected error"):
        await management_api.get_non_renewed_clients()
