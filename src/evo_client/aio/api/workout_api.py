"""Clean asynchronous Workout API."""
...
class AsyncWorkoutApi(AsyncBaseApi):
    """Clean asynchronous Workout API client."""
    ...
    async def update_workout(
        ...
        Example:
            >>> async with AsyncWorkoutApi() as api:
            ...     result = await api.update_workout(
            ...         workout_id=123,
    ...
    async def get_client_workouts(
        ...
        Example:
            >>> async with AsyncWorkoutApi() as api:
            ...     workouts = await api.get_client_workouts(
            ...         client_id=123,
            ...         inactive=False
            ...     )
    ...
    async def get_workouts_by_month_year_professor(
        self,
        professor_id: Optional[int] = None,
        ...
        Example:
            >>> async with AsyncWorkoutApi() as api:
            ...     workouts = await api.get_workouts_by_month_year_professor(
            ...         professor_id=5,
            ...         month=12,
            ...         year=2024,
            ...         take=20
    ...
    async def get_default_workouts(
        ...
        Example:
            >>> async with AsyncWorkoutApi() as api:
            ...     workouts = await api.get_default_workouts(
            ...         employee_id=10,
            ...         tag_id=5
            ...     )
            ...     for workout in workouts:
    ...
    async def link_workout_to_client(
        self,
        ...
        Example:
            >>> async with AsyncWorkoutApi() as api:
            ...     success = await api.link_workout_to_client(
