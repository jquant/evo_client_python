"""Clean asynchronous Configuration API."""
...
class AsyncConfigurationApi(AsyncBaseApi):
    """Clean asynchronous Configuration API client."""

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.base_path = "/api/v1/configuration"

    async def get_gateway_config(self) -> EmpresasFiliaisGatewayViewModel:
        """
        ...
        Example:
            >>> async with AsyncConfigurationApi() as api:
            ...     gateway_config = await api.get_gateway_config()
    ...
    async def get_branch_config(self) -> List[ConfiguracaoApiViewModel]:
        """
        ...
        Example:
            >>> async with AsyncConfigurationApi() as api:
            ...     branch_configs = await api.get_branch_config()
    ...
    async def get_occupations(self) -> List[EmpresasFiliaisOcupacaoViewModel]:
        """
        ...
        Example:
            >>> async with AsyncConfigurationApi() as api:
            ...     occupations = await api.get_occupations()
    ...
    async def get_card_flags(self) -> List[BandeirasBasicoViewModel]:
        """
        Get card flags.
        ...
        Example:
            >>> async with AsyncConfigurationApi() as api:
            ...     card_flags = await api.get_card_flags()
    ...
    async def get_translations(self) -> Any:
        """
