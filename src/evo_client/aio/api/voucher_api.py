"""Clean asynchronous Voucher API."""
...
class AsyncVoucherApi(AsyncBaseApi):
    """Clean asynchronous Voucher API client."""
    ...
    async def get_vouchers(
        ...
        Example:
            ...
            ...     vouchers = await api.get_vouchers(
            ...         valid=True,
            ...         voucher_type=1,
            ...         take=10
            ...     )
    ...
    async def create_voucher(
        ...
        Example:
            >>> async with AsyncVoucherApi() as api:
            ...     voucher = await api.create_voucher(
            ...         name="NEWUSER10",
            ...         discount_type=1,
            ...         discount_value=10.0,
