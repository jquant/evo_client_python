"""Clean asynchronous Management API."""
...
class AsyncManagementApi(AsyncBaseApi):
    """Clean asynchronous Management API client."""
    ...
    async def get_active_clients(self) -> List[ClientesAtivosViewModel]:
        """
        ...
        Example:
            >>> async with AsyncManagementApi() as api:
    ...
    async def get_non_renewed_clients(
        self,
        dt_start: Optional[datetime] = None,
        dt_end: Optional[datetime] = None,
        ...
        Example:
            >>> async with AsyncManagementApi() as api:
            ...     non_renewed = await api.get_non_renewed_clients(
            ...         dt_start=datetime(2024, 1, 1),
            ...         dt_end=datetime(2024, 12, 31)
            ...     )
