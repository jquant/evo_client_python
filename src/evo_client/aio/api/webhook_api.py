"""Clean asynchronous Webhook API."""
...
class AsyncWebhookApi(AsyncBaseApi):
    """Clean asynchronous Webhook API client."""
    ...
    async def delete_webhook(self, webhook_id: int) -> bool:
        ...
        Example:
            >>> async with AsyncWebhookApi() as api:
            ...     success = await api.delete_webhook(webhook_id=123)
            ...     if success:
    ...
    async def get_webhooks(self) -> Any:
        ...
        Example:
            >>> async with AsyncWebhookApi() as api:
            ...     webhooks = await api.get_webhooks()
    ...
    async def create_webhook(
        ...
        Example:
            >>> async with AsyncWebhookApi() as api:
            ...     success = await api.create_webhook(
