"""Clean asynchronous Payables API."""
...
class AsyncPayablesApi(AsyncBaseApi):
    """Clean asynchronous Payables API client."""
    ...
    async def get_cost_centers(
        ...
        Example:
            >>> async with AsyncPayablesApi() as api:
            ...     cost_centers = await api.get_cost_centers(take=10)
    ...
    async def get_payables(
        ...
        Example:
            >>> async with AsyncPayablesApi() as api:
            ...     payables = await api.get_payables(
