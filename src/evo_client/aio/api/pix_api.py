...
class AsyncPixApi(AsyncBaseApi):
    """Clean asynchronous PIX API client."""
    ...
    async def get_qr_code(
        ...
        Example:
            >>> async with AsyncPixApi() as api:
            ...     qr_details = await api.get_qr_code(pix_receipt_id=12345)
