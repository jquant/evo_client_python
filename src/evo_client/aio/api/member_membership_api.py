"""Clean asynchronous Member Membership API."""
...
class AsyncMemberMembershipApi(AsyncBaseApi):
    """Clean asynchronous Member Membership API client."""
    ...
    async def cancel_membership(
        ...
        Example:
            >>> async with AsyncMemberMembershipApi() as api:
            ...     result = await api.cancel_membership(
    ...
    async def get_membership(
        ...
        Example:
            >>> async with AsyncMemberMembershipApi() as api:
            ...     membership = await api.get_membership(id_member_membership=123)
    ...
    async def get_canceled_memberships(
        self,
        ...
        Example:
            >>> async with AsyncMemberMembershipApi() as api:
            ...     canceled = await api.get_canceled_memberships(
