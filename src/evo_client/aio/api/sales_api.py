...
class AsyncSalesApi(AsyncBaseApi):
    """Clean asynchronous Sales API client."""
    ...
    async def get_sale_by_id(self, sale_id: int) -> SalesViewModel:
        """
        Get sale by ID.
        ...
        Example:
            >>> async with AsyncSalesApi() as api:
            ...     sale = await api.get_sale_by_id(12345)
    ...
    async def create_sale(
        self, body: Optional[NewSaleViewModel] = None
    ) -> NewSaleResponse:
        """
        Create a new sale.
        ...
        Example:
            ...
            ...     response = await api.create_sale(sale_data)
    ...
    async def get_sales_items(
        ...
        Example:
            >>> async with AsyncSalesApi() as api:
            ...     items = await api.get_sales_items(branch_id=1)
            ...     for item in items:
    ...
    async def get_sale_by_session_id(
        ...
        Example:
            >>> async with AsyncSalesApi() as api:
            ...     sale_id = await api.get_sale_by_session_id("session123")
