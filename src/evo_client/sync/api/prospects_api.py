"""Clean synchronous Prospects API."""
...
class SyncProspectsApi(SyncBaseApi):
    """Clean synchronous Prospects API client."""
    ...
    def create_prospect(
        ...
        Example:
            ...
            ...     )
            ...     result = api.create_prospect(prospect_data)
    ...
    def update_prospect(
        ...
        Example:
            ...
            ...     )
            ...     result = api.update_prospect(prospect_data)
    ...
    def get_services(
        ...
        Example:
            >>> with SyncProspectsApi() as api:
            ...     services = api.get_services(prospect_id=12345)
    ...
    def transfer_prospect(self, transfer: ProspectTransferenciaViewModel) -> Any:
        """
        ...
        Example:
            ...
            ...     )
            ...     result = api.transfer_prospect(transfer_data)
        """
    ...
    def get_prospects_latest_branch_transfer(self, prospect_id: int) -> Any:
        """
