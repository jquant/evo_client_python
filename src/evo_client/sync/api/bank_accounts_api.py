"""Clean synchronous Bank Accounts API."""
...
class SyncBankAccountsApi(SyncBaseApi):
    """Clean synchronous Bank Accounts API client."""

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.base_path = "/api/v1/bank-accounts"

    def get_accounts(self) -> BankAccountsViewModel:
        """
        ...
        Example:
            >>> with SyncBankAccountsApi() as api:
