"""Clean synchronous Receivables API."""
...
class SyncReceivablesApi(SyncBaseApi):
    """Clean synchronous Receivables API client."""
    ...
    def get_receivables(
        ...
        Example:
            >>> with SyncReceivablesApi() as api:
    ...
    def get_revenue_centers(
        ...
        Example:
            >>> with SyncReceivablesApi() as api:
            ...     revenue_centers = api.get_revenue_centers(take=10)
    ...
    def mark_received(self, receivables: ReceivablesMaskReceivedViewModel) -> Any:
        """
        ...
        Example:
            ...
            ...     )
            ...     result = api.mark_received(receivables_data)
        """
