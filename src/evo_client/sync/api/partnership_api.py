"""Clean synchronous Partnership API."""
...
class SyncPartnershipApi(SyncBaseApi):
    """Clean synchronous Partnership API client."""
    ...
    def get_partnerships(
        ...
        Example:
            >>> with SyncPartnershipApi() as api:
            ...     partnerships = api.get_partnerships(
