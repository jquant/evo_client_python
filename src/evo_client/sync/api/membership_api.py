...
class SyncMembershipApi(SyncBaseApi):
    ...
    def get_memberships_v1(
        ...
        Example:
            >>> with SyncMembershipApi() as api:
            ...     memberships = api.get_memberships_v1(
            ...         name="Premium",
            ...         active=True,
            ...         take=10
            ...     )
    ...
    def get_memberships(
        ...
        Example:
            ...
            ...     container = api.get_memberships(name="Premium")
            ...
            ...     # Get v1 list
            ...     memberships = api.get_memberships(name="Premium", version="v1")
        """
        if version == "v1":
            return self.get_memberships_v1(
            ...
            return self.get_memberships_v2(
                membership_id=membership_id,
                name=name,
                branch_id=branch_id,
                take=take,
